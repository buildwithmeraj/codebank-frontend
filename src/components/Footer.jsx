...
const Footer = () => {
  return (
    <footer className="bg-neutral-primary-soft rounded-base shadow-xs bg-base-300/50 border-t border-neutral/20">
      <div className="w-full max-w-7xl mx-auto p-4 md:py-6">
