    ...
    <>
      ...
      <div className="page-shell">
        ...
        <div className="flex flex-col items-center gap-8 p-6">
          <div className="w-full max-w-md bg-base-200 border border-base-300 rounded-2xl shadow-md p-6 text-center">
            <h1 className="mb-4 heading-title">Profile</h1>
            {user?.photoURL ? (
              <img
                src={user.photoURL}
                alt="Profile"
            ...
            <button
              ...
              className="btn btn-error mt-2 text-white w-full flex items-center justify-center gap-2"
            >
              <LogOut size={16} />
              Logout
            </button>
